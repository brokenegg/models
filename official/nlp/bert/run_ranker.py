...
from official.nlp.bert import ranker_models
from official.nlp.bert import common_flags
from official.nlp.bert import configs
from official.nlp.bert import ranker_input_pipeline
...
def get_ranker_dataset_fn(input_file_pattern, seq_length,
                            global_batch_size,
  ...
  def _dataset_fn(ctx=None):
    ...
    train_dataset = ranker_input_pipeline.create_ranker_dataset(
        input_patterns,
        seq_length,
        batch_size,
        is_training=True,
...
def get_loss_fn():
  ...
  def _bert_ranker_loss_fn(labels, output_scores, **unused_args):
    losses = tf.nn.sparse_softmax_cross_entropy_with_logits(labels, output_scores)
    return tf.reduce_mean(losses)

  return _bert_ranker_loss_fn
...
def run_customized_training(strategy,
  ...
  train_input_fn = get_ranker_dataset_fn(input_files, max_seq_length,
                                           train_batch_size,
  ...
  def _get_pretrain_model():
    ...
    pretrain_model, core_model = ranker_models.ranker_model(
